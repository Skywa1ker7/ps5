...
The maximum year in this dataset is 2019 and the minimum year is 1960.
...
It appears to me that China had a exponential growth in CO2 emissions in
the early 2000's, this might due to its rapid economic reforms in the
late 90's. The US is also showing a slow decline in CO2 emissions in
recent years due to the mass replacement of coal power with solar,
electric and other forms of green energy. India is also steadily
climbing in total CO2 emissions as it is a fast developing nation. The
other countries I've chosen: Austria, Australia and Germany are all
pioneers in green energy and it's absolutely no surprise that they
produce substantially less CO2 emissions compared to China, the US, and
India.
...
capita. This suggests that rapidly developing countries such as China
and India have much lower CO2 emissions per capita compared to the
...
less CO2 per capita even if their population is much higher than that of
a continent with more developed nations.
...
This shows that the average CO2 per capita has actually dropped for the
Americas. Personally, I believe this to be the effect of the US
...
emission per capita as the two developing powerhouses of Asia--- China
and India are fully dedicated to the path of becoming world economical
powers. Increasing Asia's average CO2 per capita by a massive amount
from 1960 to 2016.
...
df %>% 
  ...
  geom_histogram(binwidth = 2300, position = position_dodge(width = 0.8)) +
  facet_wrap(~ time) +
  scale_fill_manual(values = hcolors) +
  labs(title = "histo", x = "GDP per Capita", fill = "Years")+
  theme_dark()
...
have *shifted* over bin width to the *right* in the span of 60 years.
...
**Finally** tell us how many hours did you spend on this PS. Around 7
hours
